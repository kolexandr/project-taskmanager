  ...
  return( 
    <div className="text-black flex-col wd-full min-h-screen p-24 align-center justify-center">
      <center>
        ...
        <p className='mt-4 font-light'>To get started, please navigate to the "Create Task" page using the sidebar on the right. There, you can add new tasks to your task list.</p>
